...
def obrabotka(data, schN, date):
    ...
    #вызов функции вывода информации о данных
    printdatainfo(data, schN)
...
def printdatainfo(data, schN):
    #вывод обработанных данных
    print(f"Ведомость остатков ст. {schN}")
    print(data.info())
    print(data)
    #print(data.to_csv(None))
    print("\n" * 4)
...
data_21_31032022 = pd.read_csv("21_31.03.2022.csv", encoding="cp1251")
data_21_30062022 = pd.read_csv("21_30.06.2022.csv", encoding="cp1251")
data_21_30092022 = pd.read_csv("21_30.09.2022.csv", encoding="cp1251")
data_21_31122022 = pd.read_csv("21_31.12.2022.csv", encoding="cp1251")
...
data_101_31032022 = pd.read_csv("101_31.03.2022.csv", encoding="cp1251")
data_101_30062022 = pd.read_csv("101_30.06.2022.csv", encoding="cp1251")
data_101_30092022 = pd.read_csv("101_30.09.2022.csv", encoding="cp1251")
data_101_31122022 = pd.read_csv("101_31.12.2022.csv", encoding="cp1251")
...
data_105_31032022 = pd.read_csv("105_31.03.2022.csv", encoding="cp1251")
data_105_30062022 = pd.read_csv("105_30.06.2022.csv", encoding="cp1251")
data_105_30092022 = pd.read_csv("105_30.09.2022.csv", encoding="cp1251")
data_105_31122022 = pd.read_csv("105_31.12.2022.csv", encoding="cp1251")
...
data21.to_csv('Ведомость остатков сч. 21 за 2022г. .csv', index=False, encoding="cp1251")

#ведомость остатков по счёту 101
data101 = pd.concat([data_101_31032022, data_101_30062022, 
                 data_101_30092022, data_101_31122022])

data101.to_csv('Ведомость остатков сч. 101 за 2022г. .csv', index=False, encoding="cp1251")

#ведомость остатков по счёту 105
data105 = pd.concat([data_105_31032022, data_105_30062022, 
                 data_105_30092022, data_105_31122022])

data105.to_csv('Ведомость остатков сч. 105 за 2022г. .csv', index=False, encoding="cp1251")

#общая ведомость остатков по всем счетам
dataedinya = pd.concat([data21, data101, data105])
dataedinya.to_csv('Ведомость остатков по сч. 21, 101, 105 за 2022г. .csv', index=False, encoding="cp1251")



#вынести классификаторы в отдельный столбец при преобразовании в csv(типа как Цена или МОЛ) - решил

#определить величины для прогнозирования - определяем так же расход, остатки 
#сопоставление остатков с расходом
#сделать скрипт, который будет переносить данные из csv в БД, в адекватном виде
#графики